...
RSpec.describe "Customers Request", type: :request do
  it "shows customer names by merchant" do
    ...
    customer1 = Customer.create!(first_name: "Parker", last_name: "Daugherty")
    customer2 = Customer.create!(first_name: "Kirstin", last_name: "Wehner")
    customer3 = Customer.create!(first_name: "Albina", last_name: "Erdman")
    customer4 = Customer.create!(first_name: "Karol", last_name: "Eloiwan")
  ...
  it "handles if a Merchant doesn't exist" do
    test_merchant1 = Merchant.create!(name: "Test Merchant1")
  ...
  it "returns an empty array when there are no customers for the merchant" do
    test_merchant = Merchant.create!(name: "Test Merchant with No Customers")

    get "/api/v1/merchants/#{test_merchant.id}/customers"
